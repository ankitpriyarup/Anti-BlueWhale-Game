<template>
  <div class="container">
    <h1 class="text-center">Anti-BlueWhale Game</h1>
...
<script>
  ...
  export default {
    ...
    methods: {
      signUp () {
        $.post('https://antibluewhale.herokuapp.com/auth/users/create/', this.$data, (data) => {
      ...
      signIn () {
        ...
        $.post('https://antibluewhale.herokuapp.com/auth/token/create/', credentials, (data) => {
