...
export default {
  ...
  methods: {
    startChatSession () {
      $.post('https://antibluewhale.herokuapp.com/api/chats/', (data) => {
    ...
    postMessage (event) {
      ...
      $.post(`https://antibluewhale.herokuapp.com/api/chats/${this.$route.params.uri}/messages/`, data, (data) => {
    ...
    joinChatSession () {
      ...
      $.ajax({
        url: `https://antibluewhale.herokuapp.com/api/chats/${uri}/`,
    ...
    fetchChatSessionHistory () {
      $.get(`https://antibluewhale.herokuapp.com/api/chats/${this.$route.params.uri}/messages/`, (data) => {
